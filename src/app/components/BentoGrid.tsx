...
export function BentoGridItem({ children, className = '', span = '' }: BentoGridItemProps) {
  return (
    <div className={`relative group ${span} ${className} transform transition-all duration-500 hover:scale-[1.02]`}>
      <div className="absolute inset-0 bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-2xl backdrop-blur-sm border border-white/10 transition-all duration-300 group-hover:border-white/20 group-hover:shadow-2xl group-hover:shadow-white/5" />
